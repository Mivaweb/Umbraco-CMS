...
namespace Umbraco.Web.Routing
{
    ...
    /// Provides urls.
    /// </summary>
    public class DefaultUrlProvider : UrlProviderBase
    {
        public DefaultUrlProvider() : base() { }

        public DefaultUrlProvider(IRequestHandlerSection requestSettings) : base(requestSettings) { }
